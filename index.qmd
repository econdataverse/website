...
| Our World In Data | Chart API | 🛠️ [owidapi](https://github.com/tidy-intelligence/r-owidapi) | |
| UNESCO | Institute of Statistics (UIS) API | 🛠️ [uisapi](https://github.com/tidy-intelligence/r-uisapi) | ✅ [unesco-reader](https://pypi.org/project/unesco-reader) |
::::

... and many more to come! 

In addition, there are additional packages that facilitate economic analysis: 

Challenge | R                                                        | Python                                                    |
|----------------|:--------------------------------------------------------:|:---------------------------------------------------------:|
| Combining Data Sources | 🛠️ [econtools](https://github.com/tidy-intelligence/r-econtools) | ✅ [bblocks](https://github.com/ONEcampaign/bblocks) |
| Standardizing Identifiers | 🛠️ [econid](https://github.com/Teal-Insights/r-econid) | |
